<div >
    ...
    $con = mysql_connect('localhost', 'root', '');
            ...
            if(isset($_GET['category'])){
                $cat=$_GET['category'];
                $result = mysql_query("SELECT * FROM blog where category='$cat'");
            }
            else{
...
if(isset($_GET['category'])){
                ...
                $query = "SELECT * FROM blog where category='$cat'  ORDER BY time DESC LIMIT $bno,$bend";
            }
            else{
                  $query = "SELECT  *
                        FROM     blog  ORDER BY time DESC  LIMIT $bno,$bend
                        ";
            }
